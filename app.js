...
function criarRespostaIA(resposta) {
  ...
  if (tipo === "cards") {
    ...
    grid.className = "ia-cards-grid";
    (Array.isArray(resposta.cards) ? resposta.cards : []).forEach((card, i) => {
      grid.appendChild(criarCardRespostaIA(card, i));
    });
