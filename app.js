...
function metaInfoHtml(item) {
  ...
  if (item.origem === "beneficio") partes.push(`<span class="item-tag item-tag-origem">Benefício</span>`);
  else if (item.origem === "saldo") partes.push(`<span class="item-tag item-tag-origem">Saldo</span>`);
